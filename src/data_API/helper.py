...
#     print(DBPath.get_index_symbols())
#     print(DBPath.get_futures_symbols())
#     print(DBPath.get_stocks_symbols())
#     print(DBPath.futures_db_path)
#     print(DBPath.stocks_db_path)
#     print(DBPath.index_db_path)
...
class DBPaths:
    ...
    def get_stocks_symbols(self) -> List[str]:
        ...
        if os.path.isfile(self.stocks_db_path):
            return SecurityDataRetriever(self.stocks_db_path).get_available_symbols()
    ...
    def get_index_symbols(self) -> List[str]:
        ...
        if os.path.isfile(self.index_db_path):
            return SecurityDataRetriever(self.index_db_path).get_available_symbols()
    ...
    def get_futures_symbols(self) -> List[str]:
        ...
        if os.path.isfile(self.futures_db_path):
            return SecurityDataRetriever(self.futures_db_path).get_available_symbols()
